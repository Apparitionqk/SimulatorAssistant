...
extension EndlessCycleProtocol where Self : UIView  {
    ...
    func autoChangePicture(collectionView: UICollectionView) {
        ...
        if nextIndex >= actualItemCount {
            ...
            collectionView.scrollToItem(at: IndexPath.init(item: nextIndex, section: 0), at: UICollectionViewScrollPosition.init(rawValue: 0), animated: true)
        }
    }
    ...
    func showFirstImagePageInCollectionView(collectionView: UICollectionView) {
        ...
        collectionView.scrollToItem(at: IndexPath.init(item: newIndex, section: 0), at: [.init(rawValue: 0)], animated: false)
    }
}
